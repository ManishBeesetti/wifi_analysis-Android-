...
//            reso = wifiManager.getScanResults();
            ...
            for (ScanResult scanResult : results) {
                textView.append(scanResult.SSID);
                textView.append(scanResult.BSSID);
                textView.append(scanResult.capabilities);
                textView.append(String.valueOf(scanResult.frequency));
                textView.append(String.valueOf(scanResult.timestamp) + "...");
                textView.append(String.valueOf(scanResult.centerFreq0));
                textView.append(String.valueOf(scanResult.centerFreq1));
    ...
    public void collect_data(View view) throws ParseException {
...

        {
            ...
            for(ScanResult scanResult : results)
            {
                ...
                parseObject.put("Iteration_No",inpview.getText());
                ...
                parseObject.put("timeStamp",String.valueOf(scanResult.timestamp));
